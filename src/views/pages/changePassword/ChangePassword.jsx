      ...
      <Grid className={classes.size} item xs={12} sm={8} md={5} component={Paper} elevation={1} square>
        <div className={classes.paper}>
          ...
          <form className={classes.form}>
            ...
            <TextField onChange={_handleChange} variant="outlined" margin='normal' required fullWidth value={password} label='New Password' name='password' type='password' />
            <Button onClick={_changePassword} type='submit' fullWidth variant='contained' color='primary' className={classes.space}>Sign In</Button>
          </form>
        </div>
      </Grid>
    </Grid>
